  ...
  return (
    <section style={{textAlign:'center'}} className='pop-up' id='detector'>
        ...
        <div style={{textAlign:'start', margin:'2em auto'}} className='col-6'>
          ...
          <p>La app es surge al momento de tener que hacer compras en el supermercado, e ir cargando lo que necesitemos para tener mayor control de que gastamos.</p>
          <br />
