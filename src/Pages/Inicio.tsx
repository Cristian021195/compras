  ...
  return (
    <section style={{textAlign:'center'}} className='pop-up' id='detector'>
        ...
        <div style={{textAlign:'start', margin:'2em auto'}} className='col-6'>
          ...
          <small><i>*Para tener siempre la ultima version, puede ser necesario <a href="/" style={{backgroundColor: 'coral', color: 'whitesmoke', margin: '0.4em', padding: '0.2em',borderRadius: '0.2em'}}>recargar</a> la web app</i></small>
          <br /><br />
